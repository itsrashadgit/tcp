                                                ...
                                                <div class="header-signin_signup-item item--signin_signup">
                                                    <div class="user-account-segment">
                                                        ...
                                                        <ul class="loggedin-user-links">
                                                            ...
                                                            <li>
                                                                <a
                                                                    href="{{ route('user.profile', Auth::user()->username ?? '') }}">Profile</a>
                                                            </li>
                                                            {{-- <li>
            ...
            <div class="tophive-bp-messenger-main-wrapper show_chat">
                ...
                <div class="th-messenger-chat-main">
                    <div class="start-new-conv">
                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" id="Capa_1"
                    ...
                    <div class="chat-filed-header"><span class="mobile-back"><svg xmlns="http://www.w3.org/2000/svg"
                                width="20" height="20" fill="currentColor" class="bi bi-arrow-left-short"
                                viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                        ...
                        <div class="recipient-avatar">
                            <div class="avatar-img"><img alt=""
                                    src="//www.gravatar.com/avatar/db9578ef026af3aa804383699b90d150?s=40&amp;r=g&amp;d=mm"
                                    srcset="//www.gravatar.com/avatar/db9578ef026af3aa804383699b90d150?s=40&amp;r=g&amp;d=mm 2x"
                                    class="avatar avatar-40 photo" height="40" width="40" loading="lazy"
                                    decoding="async">
                                <div class="item-content"><span class="name">Michael Knight</span><span
                                        class="last-activity">Active 4 weeks ago</span></div>
                            </div>
                        </div>
                        <div class="recipient-options"></div>
                    </div>
                    <div class="conversion-content open" id="conversion-content" data-thread-id="" data-sender="1"
                        data-last-id="">
                        <div class="single-conversation c-right temp"><span class="c-right">Hello<span class="time">6:20 AM</span></span></div>
                    </div>
                    <div class="conversion-form">

                        <form>
                            <textarea data-recipients="2" data-thread-id="" data-sender="1" class="conv-text" placeholder="Aa"></textarea><span class="attachemnt"></span><span
                                class="emoji"></span><span class="send--button"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    fill="currentColor" class="bi bi-cursor-fill" viewBox="0 0 20 20">
                                    <path
