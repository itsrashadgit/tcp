            ...
            <div class="entry-content">
              ...
              >
                <div id="bp-nouveau-activity-form" class="activity-update-form">
                  <form @submit.prevent="submitFeed" method="post" id="whats-new-form" name="whats-new-form" >
                            ...
                            >
                                ...
                                <div class="activity-header">
                                    ...
                                    posted an update<a href="https://theconstructionplatform.com/activity/p/60/"
                                        ...
                                        >@{{ feed.created_at }}<i class="line"></i
                                        ><span class="ac-vi-co" data-vi="1"
                                            ><span class="ac_vi_text">@{{ feed.visibility }}</span
                                            ><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            class="ionicon"
                                            viewBox="0 0 512 512"
                                ...
                                <div class="activity-footer-links">
                                    ...
                                    >
                                        ...
                                        <a
                                            ...
                                            ></path></svg>@{{ feed.total_comments }} Comments</a
                                        >
                                        </div>
                                ...
                                <div class="activity-comments-form">
                                    ...
                                    />
                                    <form
                                        @submit.prevent="() => postComment(feed.id)"
