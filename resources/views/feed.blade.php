    ...
    <div class="tophive-container">
        ...
        <div class="tabs7 mt-4">
            <ul class="nav m-0">
                ...
                <li class="nav-item"><a class="nav-link bg-white" href="{{ route('search') }}">Architects/Engineers</a></li>
                <li class="nav-item"><a class="nav-link bg-white" href="{{ route('search') }}">Trade Organizations/Associations</a></li>
                <li class="nav-item"><a class="nav-link bg-white" href="{{ route('search') }}">Trade Schools/Education</a></li>
                <li class="nav-item"><a class="nav-link bg-white" href="{{ route('search') }}">Facility/Property Mgmt</a></li>
                <li class="nav-item"><a class="nav-link bg-white" href="{{ route('search') }}">Vendors</a></li>
            </ul>
        </div>
                                ...
                                <li class="vcard d-flex align-items-center">
                                    ...
                                    <div class="item">
                                        <div class="item-title fn"><a
                                                href="https://theconstructionplatform.com/members/admin/">admin</a></div>
                                        <div class="item-meta">
                            ...
                            <div id="cover-image-container">
                                ...
                                <div id="item-header-cover-image">
                                    <div id="item-header-avatar">
                                        <img loading="lazy"
                                            src="{{ asset(Auth::user()->avatar ? '/images/user/' . Auth::user()->avatar : 'images/avatar.png') }}"
                                            class="avatar user-2-avatar avatar-50 photo" width="150" height="150"
