    ...
    <section class="position-relative py-1">
        <div class="container position-relative zindex-5 py-1 py-md-2 py-lg-2">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="usa-map">
                        <img src="{{ asset('assets/img/us.gif') }}" border="1" usemap="#usmap" class="img-fluid rounded mx-auto d-block" alt="united-state-map" >
            ...
            <map name="usmap">
                ...
                <area alt="sd" title="South Dakota" shape="circle" coords="237,98,16" href="{{ route('state.counties','nd') }}" />
