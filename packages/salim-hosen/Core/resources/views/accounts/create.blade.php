    ...
    <div class="card-body">
        <form method="POST" action="{{ route("accounts.store") }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="text-center">
                        <label for="image" role="button">
                            <img src="{{ asset("images/company.png") }}" alt="" class="img-fluid" width="120">
                ...
                <div class="col-md-9">
                    <div class="mb-3" >
                        ...
                        <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name') }}" placeholder="{{ __("Name") }}">
                        @if($errors->has('name'))
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email') }}" placeholder="{{ __("Email") }}">
                        @if($errors->has('email'))
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone') }}" placeholder="{{__("Phone")}}">
                                @if($errors->has('phone'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('phone') }}
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="text" name="mobile" id="mobile" value="{{ old('mobile') }}" placeholder="{{__("Mobile")}}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input class="form-control {{ $errors->has('fax') ? 'is-invalid' : '' }}" type="text" name="fax" id="fax" value="{{ old('fax') }}" placeholder="{{ __("Fax") }}">
                                @if($errors->has('fax'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('fax') }}
                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="mb-3">
                        <input type="text" class="form-control @error('address') is-invalide @enderror" id="address" name="address" id="address" placeholder="{{__("Address")}}">
                        @error("address")
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control @error('address_2') is-invalide @enderror" id="address_2" name="address_2" id="address_2" placeholder="{{__("Address 2")}}">
                        @error("address_2")
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city') }}" placeholder="{{__("City")}}">
                                        @if($errors->has('city'))
                                            <div class="invalid-feedback">
                                                {{ $errors->first('city') }}
                                            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <input class="form-control {{ $errors->has('person_in_charge') ? 'is-invalid' : '' }}" type="text" name="person_in_charge" id="person_in_charge" value="{{ old('person_in_charge') }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <input class="form-control {{ $errors->has('tax_id') ? 'is-invalid' : '' }}" type="text" name="tax_id" id="tax_id" value="{{ old('tax_id') }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <textarea class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" id="notes" name="notes" id="" cols="5" rows="3">{{ old('notes') }}</textarea>
                    @if($errors->has('notes'))
                        <div class="invalid-feedback">
                            {{ $errors->first('notes') }}
                        </div>
