            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title') }}" placeholder="{{__("Mr")}}/{{ __("Mrs") }}">
                        @if($errors->has('title'))
                            <div class="invalid-feedback">
                                {{ $errors->first('title') }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="contact_source" id="contact_source" class="form-control {{ $errors->has('contact_source') ? 'is-invalid' : '' }}">
                            ...
                            @foreach (["Email", "Facebook"] as $source)
                                <option @if(old('contact_source') == $source) selected @endif value="{{ $source }}">{{ $source }}</option>
                            @endforeach
                        </select>
