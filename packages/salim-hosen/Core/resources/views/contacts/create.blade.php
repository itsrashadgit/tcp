    ...
    <div class="card-body">
        <form method="POST" action="{{ route("contacts.store") }}" enctype="multipart/form-data">
                ...
                <div class="col-md-3">
                    <div class="text-center">
                        <label for="image" role="button">
                            <img src="{{ asset("images/avatar.png") }}" alt="" class="img-fluid" width="120">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <input class="form-control {{ $errors->has('job_position') ? 'is-invalid' : '' }}" type="text" name="job_position" id="job_position" value="{{ old('job_position') }}">
