...
<div class="d-flex mb-3">
    <a class="btn @if(request('locale') == 'en') btn-primary @else btn-secondary @endif" href="{{ route('pages.edit', ['page' => $page['id'], 'locale' => 'en']) }}">{{ __("English") }}</a>
    <a class="btn @if(request('locale') == 'ar') btn-primary @else btn-secondary @endif ml-1" href="{{ route('pages.edit', ['page' => $page['id'], 'locale' => 'ar']) }}">{{ __("Arabic") }}</a>
</div>
        ...
        <div class="card-body">
            <form action="{{ route('pages.update', $page->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control @error('url') is-invalid @enderror" id="menu-url" name="url" value="{{ old('url', $page->url) }}" readonly>
                        @error('url')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $page->title) }}">
                    @if($errors->has('title'))
                        <div class="invalid-feedback">
                            {{ $errors->first('title') }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control {{ $errors->has('keywords') ? 'is-invalid' : '' }}" type="text" name="keywords" id="keywords" value="{{ old('keywords', $page->keywords) }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" id="description" cols="30" rows="3" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" >{{ old('description', $page->description) }}</textarea>
            ...
            <div class="mb-3">
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" name="is_active" type="checkbox" @if($page->is_active) checked @endif >
